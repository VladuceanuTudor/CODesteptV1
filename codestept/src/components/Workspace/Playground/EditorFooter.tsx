...
const EditorFooter: React.FC<EditorFooterProps> = ({ handleSubmit }) => {
  return (
    <div className="flex bg-dark-layer-1  bottom-0 left-0 right-0 z-10 w-full border-t border-dark-layer-2">
      <div className="mx-5 my-[10px] flex justify-between w-full">
        <div className="mr-2 flex flex-1 flex-nowrap items-center space-x-4">
          <button
            ...
            onClick={() => console.log("Console clicked")} // Placeholder for console toggle
          >
            Console
